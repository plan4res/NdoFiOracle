...
/*--------------------------------------------------------------------------*/
/** @file
 * Definition of the abstract class Deflection, which defines the interface
 * for computing the deflection coefficient within the SubGrad class [see
 * SubGrad.h].
 *
 ...
 * improvement [see Delta()]. */
   ...
   virtual bool DoSS( void ) { return( true ); }
 ...
 */
   ...
   virtual HpNum Delta( void ) { return( Inf< HpNum >() ); }
